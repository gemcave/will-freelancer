class GigsController < ApplicationController
	...
	def update
		...
		if @step == 4 && @gig.photos.blank?
			return redirect_to request.referrer, flash: {error: "You dont't have any photos"}
		end
		...
		if @step == 5
			...
			if @gig.description.blank?
				...
				return redirect_to edit_gig_path(@gig, step: 4), flash: {error: "You dont't have any photos"}
			end
		end
